  ...
  return (
    <div className="p-4 sm:p-8 max-w-7xl mx-auto space-y-8">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <Link href="/owner/properties" className="dashboard-btn w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-xl font-bold text-sm shadow-sm flex items-center justify-center gap-2">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        {[
          ...
          <div key={metric.title} className={`dashboard-card dashboard-card-rise stagger-${idx + 1} bg-white p-5 sm:p-6 rounded-3xl border border-slate-200 shadow-sm flex items-center gap-4 sm:block group`}>
            <div className={`w-12 h-12 ${metric.bg} ${metric.color} rounded-2xl flex items-center justify-center sm:mb-4 shrink-0 group-hover:scale-110 transition-transform duration-300`}>
              {metric.icon}
            </div>
            <div>
      ...
      <div className="dashboard-card-rise stagger-5 bg-blue-50/80 border border-blue-100 rounded-3xl p-6 sm:p-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 shadow-sm">
        <div>
        ...
        <Link href="/owner/leads" className="dashboard-btn w-full sm:w-auto text-center bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-2xl font-black text-sm shadow-md hover:shadow-lg shrink-0">
          Go to Marketplace
        </Link>
      </div>
    </div>
